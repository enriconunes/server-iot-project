...
import { Radio, Wifi, WifiOff, Signal, Bell, BellOff } from "lucide-react"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    es.addEventListener("bell", (event) => {
      try {
        const bell = JSON.parse((event as MessageEvent).data)
        setBellActive(bell.active)
        setBellUpdatedAt(bell.updatedAt)
      } catch {
        // ignore
      }
    })
